package timeroute.androidbaby.api.exception;
    ...
    public static ApiException handleException(Throwable e){
        ...
        if (e instanceof HttpException){             //HTTP错误
            ...
            switch(httpException.code()){
                case UNAUTHORIZED:
                    ex.setDisplayMessage("未认证");
                    break;
                case FORBIDDEN:
                    ex.setDisplayMessage("请求禁止");
                    break;
                case NOT_FOUND:
                    ex.setDisplayMessage("请求资源不存在");
                    break;
                case REQUEST_TIMEOUT:
                    ex.setDisplayMessage("请求超时");
                    break;
                case GATEWAY_TIMEOUT:
                    ex.setDisplayMessage("网关超时");
                    break;
                case INTERNAL_SERVER_ERROR:
                    ex.setDisplayMessage("内部服务器错误");
                    break;
                case BAD_GATEWAY:
                    ex.setDisplayMessage("错误网关");
                    break;
                case SERVICE_UNAVAILABLE:
                    ex.setDisplayMessage("服务器无效");
                    break;
                default:
