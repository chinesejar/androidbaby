...
public class CommentNotificationListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentNotificationListAdapter(Context context, CommentTimeLine commentTimeLine) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_FOOTER) {
            ...
            View view = View.inflate(parent.getContext(), R.layout.layout_notification_comment, null);
